...
const skills = [
  ...
  {
    name: 'Git',
    icon: <i className="devicon-git-plain colored text-3xl sm:text-7xl" />,
  },
  {
    name: 'MongoDB',
  ...
  {
    name: 'Docker',
    icon: <i className="devicon-docker-plain colored text-3xl sm:text-7xl" />,
  },
  {
    name: 'NodeJS',
