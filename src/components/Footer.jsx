            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="flex justify-center gap-8 mb-10">
                    {[{
                        ...
                        icon: SiLeetcode,
                        href: "https://leetcode.com/u/bikund2017/"
                    }, {
                        icon: FaTwitter,
                        href: "https://x.com/bikund2017"
                    }, {
                        icon: FaLinkedin,
                        href: "https://www.linkedin.com/in/bikund2017/"
                ...
                <p className="text-center text-sm text-white/70">
                    © {new Date().getFullYear()} <span className="font-bold text-[#00c6ff]">Bikund Kumar</span>. All rights reserved.
                </p>
            </div>
        </footer>
    );
