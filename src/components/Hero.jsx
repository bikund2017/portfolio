            ...
            <div className="flex flex-col items-start sm:items-center lg:items-start gap-4 z-10">
                ...
                >
                    <h1 className="text-5xl sm:text-5xl lg:text-7xl font-bold text-white mb-6">
                        Hello!, I&apos;m <br />
                        <span className="gradient-text-hero pulse-glow">Bikund Kumar</span>
                    </h1>

                    <p className="text-lg md:text-xl text-white/90 max-w-2xl mb-6">
                        Building modern web applications with a focus on backend, cloud, and databases.
                        Enjoy working with Node.js, Express, and DevOps tools to make systems efficient.
                    </p>
